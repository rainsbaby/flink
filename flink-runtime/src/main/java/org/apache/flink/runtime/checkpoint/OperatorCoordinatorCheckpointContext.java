...
/**
 * 用于CheckpointCoordinator 与 OperatorCoordinator在checkpoint/checkpoint恢复时的交互。 This context is the
 * interface through which the {@link CheckpointCoordinator} interacts with an {@link
