 ...
 *
 * <p>This service has the responsibility to monitor the job leaders (the job manager which is
 * leader for a given job) for all registered jobs. Upon gaining leadership for a job and detection
 * by the job leader service, the service tries to establish a connection to the job leader. After
